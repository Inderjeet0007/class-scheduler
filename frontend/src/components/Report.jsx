  ...
  return (
    <div>
      ...
      <p style={{ color: "#555", marginBottom: "20px" }}>
        This report displays all scheduled driving classes with detailed
        information about students, instructors, and class types. Use the
        filters below to refine the report by instructor name or specific date.
      </p>
      ...
      >
        ...
        <button
          ...
          style={{
            padding: "8px 16px",
            backgroundColor:
              !filterInstructor && !filterDate ? "#ccc" : "#3b5dcc",
            color: "#fff",
            border: "none",
            borderRadius: "6px",
            cursor:
              !filterInstructor && !filterDate ? "not-allowed" : "pointer",
            transition: "0.2s",
          }}
        >
          Reset
